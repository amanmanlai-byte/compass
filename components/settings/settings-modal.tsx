...
export default function SettingsModal({ open, onClose }: SettingsModalProps) {
  ...
  const tabs = [
    { id: "api-keys", icon: KeyRoundIcon, label: "模型与API" },
    { id: "appearance", icon: PaletteIcon, label: "外观" },
    { id: "system-prompt", icon: MessageSquareIcon, label: "提示词" },
    { id: "advanced", icon: Settings2Icon, label: "高级" },
  ];

  return (
    <div className="glass-settings-modal" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="glass-settings-backdrop" />
      <div className="glass-settings-content" onClick={(e) => e.stopPropagation()}>
        {/* Header */}
        ...
        <div className="flex h-[calc(85vh-64px)]">
          {/* Sidebar Tabs */}
          <div className="w-44 shrink-0 border-r border-white/[0.06] p-3">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    activeTab === tab.id
                      ...
                      : "text-muted-foreground/60 hover:text-foreground/70 hover:bg-white/[0.04]"
                  )}
                >
            ...
            {activeTab === "api-keys" && (
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <p className="mb-4 text-xs text-muted-foreground/60">无需 API Key，需先在本机安装并运行 Ollama</p>
                  <div className="space-y-3">
                    <div>
            ...
            {activeTab === "appearance" && (
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <p className="mb-4 text-xs text-muted-foreground/60">切换背景效果</p>
